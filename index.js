...
client.on("channelDelete", (channel) => {
    if (channel.parentID == channel.guild.channels.cache.find((x) => x.name == "MODMAIL").id) {
        ...
        let yembed = new discord.MessageEmbed()
            ...
            .setColor('RED')
            .setDescription("If you dont need any more help please don't chat in the dms as it is disturbing for our staff members")
    ...
    if (!message.guild) {
        ...
        if (!main) {
            ...
            let sembed = new discord.MessageEmbed()
                ...
                .setColor("GREEN")
                .setThumbnail(client.user.displayAvatarURL())
                .setDescription("Conversation is now started, you will be contacted by Dark Emblem staff's soon")
